...
public class GeneticSystem : MonoBehaviour
{
    ...
    public int mutationNormalizer = 7;

    [Header("Inheritance Controls")]
    ...
    {
        population = new NNetwork[initialPopulation];
    ...
    private void RePopulate()
    {
        ...
        NNetwork[] newPopulation = PickBestPopulation();
    ...
    private void Mutate (NNetwork[] newPopulation)
    {
    ...
    Matrix<float> MutateMatrix (Matrix<float> A)
    {
        ...
        int randomPoints = Random.Range(1, (A.RowCount * A.ColumnCount) / mutationNormalizer);
